...
It helps the player visually identify patterns and clusters.
It creates an emotional arc: the empty ocean at the start contrasts with the scarred water at the end.

...
(function () {
  ...
  function updatePlacementUI() {
    if (placementIdx < SHIPS.length) {
      ...
      $placeHint.textContent = 'Click a square to place \u00b7 Press R to rotate \u00b7 Direction: ' + (placementDir === 'h' ? 'Horizontal \u2192' : 'Vertical \u2193');
    } else {
    ...
    for (var i = 0; i < SHIPS.length; i++) {
      ...
      tag.className = 'ship-tag' + (i < placementIdx ? ' placed' : '') + (i === placementIdx ? ' placing' : '');

...
(function () {
  ...
  function startAmbient() {
    ...
    droneOsc.start();
    droneGain.gain.linearRampToValueAtTime(0.18, audioCtx.currentTime + 3);
    ...
    drone2.start();
    drone2Gain.gain.linearRampToValueAtTime(0.10, audioCtx.currentTime + 4);
    ...
    whiteNoise.start();
    noiseGain.gain.linearRampToValueAtTime(0.14, audioCtx.currentTime + 4);
